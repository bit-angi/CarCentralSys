#ifndef LittlePicWidget_H
#define LittlePicWidget_H
...
QT_BEGIN_NAMESPACE
namespace Ui {
class LittlePicWidget;
}
QT_END_NAMESPACE


class LittlePicWidget : public QWidget
{
    Q_OBJECT


public:
    explicit LittlePicWidget();
    ~LittlePicWidget();

private:
    Ui::LittlePicWidget *ui;
    ...
    QWidget *thumbnailLittlePicWidget;
